...
contract BulletLoans is ERC721Upgradeable, IBulletLoans {
    ...
    function repay(uint256 instrumentId, uint256 amount) external override {
    ...
    function underlyingToken(uint256 instrumentId) external view override returns (IERC20) {
